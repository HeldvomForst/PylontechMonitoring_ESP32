...
/* ---------------------------------------------------------
   Render the BAT settings page
   - Dynamic BAT parser fields
   - Raw data from lastBatData
   - MQTT + Send logic
...
function changeLang(){
  ...
  if(lang==='en'){
    ...
    document.getElementById('batLabel').innerHTML='Cell Subtopic<br>';
    document.getElementById('intervalTitle').innerText='Query Interval';
    document.getElementById('intervalLabel').innerHTML='BAT (seconds)<br>';
